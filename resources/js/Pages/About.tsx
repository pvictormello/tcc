    ...
    <Layout user={auth.user} currentLink="about">
      ...
      <div className="container mx-auto pb-16">
        <div className="mx-auto w-2/3">
          <Breadcrumbs currentRoute={t("About")} />
          ...
          <div className="rounded-lg bg-white p-6 shadow">
            ...
            <div className="mt-12 flex flex-col">
              <p className="text-justify">
                &nbsp A Universidade Federal de Uberlândia, campus Monte Carmelo, criou no ano de 2013 o banco de
              ...
              <p className="mt-8 text-justify">
                &nbsp Os acessos são caracterizados conforme{" "}
              ...
              <p className="mt-8 text-justify">
                &nbsp A Universidade Federal de Uberlândia, na categoria de mantenedora do BG <i>Capsicum</i> UFU se
