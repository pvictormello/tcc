  ...
  return (
    <div className="relative">
      <input
        ...
        type="radio"
      />
      <label className="flex h-full flex-1 cursor-pointer flex-col items-center justify-center gap-4 rounded-md border p-3 text-center text-sm font-semibold ring-1 ring-gray-200 peer-checked:bg-blue-600 peer-checked:text-white peer-checked:ring-0 peer-focus:ring-2 peer-focus:ring-blue-600 peer-focus:ring-offset-2">
...
const RadioGroup = ({
  gridCols,
  children,
}: PropsWithChildren<{ gridCols: string }>) => {
